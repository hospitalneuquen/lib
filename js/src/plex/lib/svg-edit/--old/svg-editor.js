...
//						|| elem && elem.tagName == "path" && !multiselected) { // This was added in r1430, but not sure why
			...
			var setIconSize = editor.setIconSize = function (size) {
                // 08/10/2015 | jgabriel | Esconde los elementos padre? WTF?
			    return;
			...
			*/
			...
			(function() {
				...
				$.each(toolnames, function (i, item) {
                    // 06/10/2015 | jgabriel | Corregí bug
...
//			});
		...
		editor.runCallbacks = function () {
		    ...
		    // 13/10/2015 | jgabriel | Debe borrar para que no vuelva a ejecutar
			callbacks = [];
		};
...
//			});
    ...
    // 07/10/2015 | jgabriel | Esto lo hago desde la directiva de Angular
	//$(svgEditor.init);
